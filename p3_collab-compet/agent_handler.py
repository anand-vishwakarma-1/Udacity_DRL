...
class AgentHandler:
    ...
    def __init__(self, num_agents=2, state_size=24, action_size=2):
        ...
        self.agents = [Agent(state_size, action_size, i+1, random_seed=257) for i in range(num_agents)]
        
        # Replay memory
        self.memory = ReplayBuffer(action_size, BUFFER_SIZE, BATCH_SIZE, seed=257)
